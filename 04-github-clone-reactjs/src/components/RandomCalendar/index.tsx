...
type ReactCalendarHeatmapValue = { date: Date; count?: number | undefined };
    ...
    <Container>
      <div className="wrapper">
        <Heatmap
          ...
          gutterSize={3.5}
          classForValue={(value: ReactCalendarHeatmapValue | undefined) => {
            let clampedCount = 0;

            // Check if the value is defined
            if (value && value.count !== undefined) {
              clampedCount = Math.max(value.count, 0);
